 ...
 * This represents the whole window containig all the buttons and menu entries.
...
public class View extends JFrame {
	 ...
	 * this method could be easily extended, to load whatever AddOn can be found in a certain folder.
	 */
