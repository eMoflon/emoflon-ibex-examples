...
public class _SchemaBasedAutoRegistration {
	...
	public static void register(OperationalStrategy strategy) throws IOException {
		strategy.loadAndRegisterMetamodel("platform:/resource/UserEnviro/model/UserEnviro.ecore");
		strategy.loadAndRegisterMetamodel("platform:/resource/UIAdaptation/model/UIAdaptation.ecore");
	}
